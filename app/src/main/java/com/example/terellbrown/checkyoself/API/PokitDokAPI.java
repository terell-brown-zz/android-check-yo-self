...
public interface PokitDokAPI {
    ...
    Call<Provider> getProvider(@Header("Authorization") String authorization, @Field("zipcode") String zipcode, @Field("specialty") String specialty, @Field("radius") String radius);
}
